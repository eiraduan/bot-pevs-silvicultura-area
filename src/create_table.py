...
def main(): 
    ...
    try:
        ...
        print(f"Verificando e criando a tabela '{TABELA}' se ela não existir...")
        ...
        CREATE TABLE IF NOT EXISTS {TABELA}(
            ...
            especie_florestal_codigo INTEGER,
            especie_florestal VARCHAR(255)
        );
        """
        cursor.execute(create_table_query)
        
        conexao.commit()
        print(f"Tabela '{TABELA}' verificada/criada com sucesso.")
